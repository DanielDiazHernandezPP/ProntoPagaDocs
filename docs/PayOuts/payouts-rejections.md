...
<table>
  ...
  <tbody>
    ...
    <tr><td>26</td><td>Withdrawal amount exceeds limits, please retry with a valid amount</td><td>Monto de retiro excede los limites, por favor reintentar con un monto valido.</td></tr>  
    <tr><td>26</td><td>Exceeds the maximum transaction amount per month</td><td>Monto de retiro excede los limites, por favor reintentar con un monto valido.</td></tr>  
  </tbody>
</table>
`}</HTMLBlock>
