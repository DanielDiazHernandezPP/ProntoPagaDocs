...
excerpt: Conoce el paso a paso de cómo hacer un retiro instantáneo con wallet en Perú.
deprecated: false
hidden: false
metadata:
...
Si el cliente intenta superar los límites permitidos, se le [mostrará un mensaje de rechazo](https://docs.prontopaga.com/docs/instant-payout-wallet#motivos-de-rechazo).
