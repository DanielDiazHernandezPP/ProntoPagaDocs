...
excerpt: Conoce el paso a paso de cómo hacer un retiro por transferencia en Chile.
deprecated: false
hidden: false
metadata:
...
next:
  description: ''
---
Hacer un retiro en Chile por medio de transferencia bancaria consiste en capturar los datos necesarios de la persona que recibirá el pago y hacer una solicitud a través de nuestra API con un Bearer Token y una secretKey. De esta forma, las transacciones se autentican y se realizan de forma segura.
...
<Image align="center" border={false} src="https://files.readme.io/13560fca486b2b1ac4120d7c4ba0c60c7efa2c93c9b080de22fe45e0a1327042-Chile-01.jpg" />
