...
next:
  description: ''
---
Crear un pago en México con CoDi consiste en capturar los datos necesarios del cliente para el pago y hacer una solicitud a través de nuestra API con un bearer token y una firma secreta. De esta forma, las transacciones se autentican y se realizan de forma segura.
...
De este modo, el cliente podrá escanear el QR con la aplicación de CoDi o con la aplicación de su banco y hacer el pago.
