...
| El servicio de validación no esté en general respondiendo correctamente.                                           | `The validation service is currently unavailable. Please try again, and if the error persists, contact your KAM` |
