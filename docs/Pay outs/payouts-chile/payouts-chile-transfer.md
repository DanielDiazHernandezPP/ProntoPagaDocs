...
Para hacer una solicitud de nuevo retiro a través de nuestra API deberás usar [este endpoint](https://docs.prontopaga.com/reference/bank-transfer-payout). La solicitud se envía con tu bearer token, así como con tu firma secreta. 
