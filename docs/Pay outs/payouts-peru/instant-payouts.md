---
title: Cuenta Interbancaria (retiros instantáneos)
excerpt: ''
deprecated: false
hidden: false
metadata:
...
Consulta el endpoint de [Crear un nuevo retiro](https://docs.prontopaga.com/reference/bank-transfer-payout) y envía una solicitud con un body similar a la siguiente.
