...
next:
  description: ''
---
Para crear un nuevo retiro por transferencia bancaria en Chile, Ecuador o Perú, es necesario utilizar [este endpoint](https://docs.prontopaga.com/reference/bank-transfer-payout), en el cual se debe enviar el código bancario en el parámetro `bankCode`. En este artículo se muestran las listas de códigos bancarios por país.
...
[
   ...
   {
      "code": 79,
      "name": "COOP.DE AHORRO Y CREDITO POLICIA NACIONAL 82 FINANCOOP"
   },
   {
      "code": 201,
   ...
   {
      "code": 375,
      "name": "COOP. AHORRO Y CREDITO CAMARA DE COMERCIO INDIGENA 379 COOP. DE A. Y C. GUAMOTE LTDA."
   },
   {
      "code": 382,
   ...
   {
      "code": 519,
      "name": "COOP A Y C ESC SUP POLITEC AGROP DE MANABI MANUEL 526 COOP DE AHORRO Y CREDITO FASAYNAN LTDA"
   },
   {
      "code": 546,
   ...
   {
      "code": 2557,
      "name": "COOP DE AHORRO Y CREDITO LA MERCED 338 COOP. DE A. Y C. COOPTOPAXI LTDA."
   },
   {
      "code": 620,
   ...
   {
      "code": 626,
      "name": "COOP. DE A Y C. SERVIDORES MUNICIPALES DE CUENCA 628 COOP. DE AHORRO Y CREDITO PROFUTURO LTDA."
   },
   {
      "code": 640,
