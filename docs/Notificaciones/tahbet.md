...
metadata:
  robots: index
---
<Accordion title={<span style={{ fontSize: '20px', fontWeight: 'bold' }}><img src="URL_ICONO_BANCO_CHILE" alt="Banco de Chile" style={{ height: '20px', verticalAlign: 'middle', marginRight: '8px' }}/>Banco de Chile</span>}>
