---
title: Status page de ProntoPaga
excerpt: >-
...
metadata:
  robots: index
---
La página VTEX Status te permite monitorear la estabilidad de la plataforma en tiempo real y acceder al historial completo de incidentes.
