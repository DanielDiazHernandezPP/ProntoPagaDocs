...
<Cards columns={2}>
  <center>
    <Card>
      ...
      <Button variant="primary" text="Ver guía" style={{ width: '15px', height: '7px', marginBottom: '0px' }} icon="fa-solid fa-arrow-up-right-from-square" href="https://docs.prontopaga.com/docs/prestashop#/" target="_blank"  />
    </Card>
  </center>
