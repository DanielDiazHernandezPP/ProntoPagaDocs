...
>
> Consulta el listado de marcas de tarjetas aceptadas en transacciones a través de ProntoPaga para Ecuador, Chile y Perú en <Anchor label="este artículo" target="_blank" href="https://docs.prontopaga.com/docs/card-brands#/">este artículo</Anchor>.
