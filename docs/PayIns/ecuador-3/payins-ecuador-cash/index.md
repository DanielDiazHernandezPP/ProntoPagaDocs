...
excerpt: Conoce el paso a paso de cómo crear un pago con efectivo en Ecuador.
deprecated: false
hidden: false
metadata:
...
<Tabs>
  ...
  <Tab title="Logotipos">
    * 📥 Agregar los logotipos de los diferentes métodos de pago de ProntoPaga a tu *front-end*. Puedes [descargarlos aquí](https://drive.google.com/uc?export=download\&id=1_eLEpVX9Vym2pDMMigDE8gyzQBlO_2WB).
