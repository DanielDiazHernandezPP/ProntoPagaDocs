...
3. **Redirección y autorización** El cliente es redirigido al portal de su banco, en donde deberá iniciar sesión y seguir las instrucciones en pantalla para hacer la transferencia.
   * Por única vez, \*\*se solicitará al cliente el registro previo de la cuenta receptora \*\*para acelerar futuras transacciones.
