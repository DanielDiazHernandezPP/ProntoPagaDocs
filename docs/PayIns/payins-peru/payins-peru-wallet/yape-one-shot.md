...
<table>
  ...
  <tbody>    
		<tr><td><code>YPTRX000</code></td><td>Confirmación de transacción exitosa</td><td><b>Mostrar pantalla de win state.</td><td>Yape notifica transacción exitosa por push y email</b></td></tr>
