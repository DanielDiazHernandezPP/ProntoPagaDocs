...
metadata:
  ...
  image: >-
    https://files.readme.io/b29e07de5bbd625f7db3798d912d0de3fbbad1fbcc849c2269b0c657c11743a2-Prontopaga_logotipo.png
  keywords:
    - endpoint Prontopaga
    - cancel a QR
    - cancel a payment
...
Con este _endpoint_ puedes cancelar un pago con **QR _mobile_ en Argentina** buscando la transacción por su `uid`. Esto evita que un cliente conserve la imagen del QR o código e intente realizar el pago posteriormente.
