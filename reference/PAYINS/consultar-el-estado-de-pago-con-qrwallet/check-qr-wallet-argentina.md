...
Este _endpoint_ permite consultar el estado actual del pago con QR en Argentina. [Conoce los estados de los PayIns](https://docs.prontopaga.com/docs/payins-status) en nuestra guía.