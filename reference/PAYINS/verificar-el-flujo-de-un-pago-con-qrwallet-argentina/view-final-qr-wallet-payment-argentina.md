---
title: Ver flujo final QR/Walltet -QR mobile
api:
...
Este _endpoint_ se utiliza para visualizar el flujo final de **pago con QR _mobile_ en Argentina**. Redirige a la página HTML final de ProntoPaga. Busca el pago mediante su `uid` y no realiza validaciones adicionales ni modifica el estado de la transacción.
