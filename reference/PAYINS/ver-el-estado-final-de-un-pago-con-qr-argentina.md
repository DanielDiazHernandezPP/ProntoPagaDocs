---
title: Ver el estado final de un pago con QR-Argentina
api:
...
Este endpoint se utiliza para finalizar el flujo de pago con QR en Argentina, redirigiendo al usuario a la página HTML final de ProntoPaga. 
